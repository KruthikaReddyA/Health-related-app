...
<head>
    ...
    <title>Autoimmune Disorder form</title>
...
<body bgcolor="#304a6b">
    ...
    <form>
        <br>
        <h1>Self Assessment : AUTOIMMUNE DISORDER</h1><br><br>
        <label for="question1">1.Have you been diagnosed with an autoimmune disorder?</label><br><br>
        ...
        <label for="question2">2.How often do you experience unexplained fatigue or tiredness?</label><br><br>
    ...
    <br><br><br><br>
                ...
                <label for="question3">3.Do you have recurrent fevers or feel feverish without an obvious cause?</label><br><br>
            ...
            <br><br><br><br>
                ...
                <label for="question4">4.Do you experience stiffness in your joints, especially in the morning?</label><br><br>
            ...
            <br><br><br><br>
                ...
                <label for="question5">5.How often do you have muscle pain or weakness?</label><br><br>
